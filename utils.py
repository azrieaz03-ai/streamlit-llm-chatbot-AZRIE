# utils.py
# NOTE: This template supports multiple backends. Replace 'mock' functions
# with real LangChain/OpenAI calls when integrating for real.
...
"""Mock LLM generator. Replace with real LLM API calls (OpenAI, Anthropic, etc.) or LangChain chains."""
...
answer = "Berikut saran untukmu: Gunakan teknik Pomodoro (25/5), prioritaskan 3 tugas teratas, dan cek kalender untuk deadline."
